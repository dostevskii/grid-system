...
const en: Record<string, string> = {
  ...
  overlay: "Grid + text", text: "Text", grid: "Grid", fields: "modules",
  ...
  exportLayout: "Export layout", exportIntro: "Take this grid into your next project.", gridOnly: "Grid only", textOnly: "Text only",
